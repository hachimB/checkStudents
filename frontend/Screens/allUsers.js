...
//         setStudentCount(querySnapshot.size);  // Set the total number of students
//       } catch (error) {
...
//             <View style={[styles.itemContainer, styles.border]}>
//               <TouchableOpacity onPress={() => { navigation.navigate('UsersGrade', { studentId: student.id }) }} style={styles.boutonprofile}>
